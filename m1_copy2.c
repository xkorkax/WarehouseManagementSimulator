    ...
    czas_start_K3 = clock();
        ...
        {   
            if(getpid() == id_K1)    //kurier1
            {
                ...
                if(((double)(czas_stop_K1 - czas_start_K1)/CLOCKS_PER_SEC)*10>10)
                {
                ...
                {   //zegar dla K1 stop
                    czas_start_K1 = clock();
                    //zegar dla K1 start
                    printf("zamowienie odebral kurier 1 magazunu 2: A: %d, B: %d, C: %d\n", message.data_a, message.data_b, message.data_c);
            ...
            else if(getpid() == id_K2)      //kurier2
            {
                //sprawdzanie, ile upłynelo od odebrania poprzedniego zamowienia
                czas_stop_K2 = clock();
                if(((double)(czas_stop_K2 - czas_start_K2)/CLOCKS_PER_SEC)*10>10)
                {
                ...
                {
                    czas_start_K2 = clock();
                    printf("zamowienie odebral kurier 2 magazunu 2: A: %d, B: %d, C: %d\n", message.data_a, message.data_b, message.data_c);
                    //kurier wysyła do magazynu zapytanie o możliwość realizacji zamówienia
            ...
            {
                czas_stop_K3 = clock();
                if(((double)(czas_stop_K3 - czas_start_K3)/CLOCKS_PER_SEC)*10>10)
                {
                ...
                {
                    czas_start_K3 = clock();
                    printf("zamowienie odebral kurier 3 magazunu 2: A: %d, B: %d, C: %d\n", message.data_a, message.data_b, message.data_c);
                   //kurier wysyła do magazynu zapytanie o możliwość realizacji zamówienia
            ...
            while(1)
            {
                ...
                if(pracujacy_kurier1 == 1)
                {
                    ...
                    {   if(message2.data_a == 999999) 
                        ...
                        {
                            do_zaplaty_K1 = 0;
                            printf("---Magazyn2 do kuriera1: NIE mozna zrealizowac zamowienia\n");
                            if(write(pipe4_desc[1], &do_zaplaty_K1, sizeof(int))==-1){
                ...
                if(pracujacy_kurier2 == 1)
                {
                    ...
                    else 
                    {
                        ...
                        {
                            do_zaplaty_K2 = 0;
                            printf("---Magazyn2 do kuriera2: NIE mozna zrealizowac zamowienia\n");
                            if(write(pipe5_desc[1], &do_zaplaty_K2, sizeof(int))==-1)
                            {
                                perror("Błąd zapisu do  potoku\n");
                            }
                ...
                if(pracujacy_kurier3==1)
                {
                    ...
                    else 
                    {
                        ...
                        {
                            do_zaplaty_K3 = 0;
                            printf("---Magazyn2 do kuriera3: NIE mozna zrealizowac zamowienia\n");
                            if(write(pipe6_desc[1], &do_zaplaty_K3, sizeof(int))==-1)
                            {
                                perror("Błąd zapisu do potoku\n");
                            }
