...
{ 
    ...
    int zarobione1 = 0;             //magazyn liczy ile zarobil kazdy z kurierow i sumuje na koncu
    int zarobione2 = 0;             //
    int zarobione3 = 0;             //
    int pipe1_desc[2], pipe2_desc[2], pipe3_desc[2], pipe4_desc[2], pipe5_desc[2], pipe6_desc[2];       //
    int do_zaplaty_K1 = 0;           //zmienna używana do przesłania kwoty za zamowienie (magazyn -->kurier)
    int feedback_do_zaplaty_K1 = -1; //zmienna używana do przesłania odpowiedzi (kurier1 --> dyspozyotrnia), czy magazyn moze zrealizowac zamowienie
    int do_zaplaty_K2 = 0;  //
    int feedback_do_zaplaty_K2 = -1; //
    int do_zaplaty_K3 = 0;  //
    int feedback_do_zaplaty_K3 = -1; //
    int suma_zarobione_K1 = 0; // kurier liczy sobue ile zarobil, ale w sumie potrzebne tylko do sprawdzenia
    ...
    {       
        ...
        if(getppid() == ID_procesu_pierwotnego)
        {
            ...
            {
                if(msgrcv(ID_kolejki, &message, sizeof(message)-sizeof(long), 1, 0)==-1)                        //kurier odbiera zamowienia z glownego kanalu
                {
            ...
            {
                if(msgrcv(ID_kolejki, &message, sizeof(message)-sizeof(long), 1, 0)==-1)
                {
            ...
            while(1)
            {
                ...
                if(pracujacy_kurier1 == 1)
                {
                    ...
                    else                                                                                               // Wartości zostały pomyślnie odczytane
                    {
                        ...
                        if(message2.data_a <= stanA && message2.data_b <= stanB && message2.data_c <= stanC)            //sprawdzamy, czy magazyn moze zrealizowac zamowienie
                        {
                            ...
                            write(pipe4_desc[1], &do_zaplaty_K1, sizeof(int));
                        ...
                        {
                            do_zaplaty_K1 = 0;
                            printf("---Magazyn1 do kuriera1: NIE mozna zrealizowac zamowienia\n");
                ...
                if(pracujacy_kurier2 == 1)
                {
                    ...
                    else 
                    {
                        ...
                        if(message2.data_a <= stanA && message2.data_b <= stanB && message2.data_c <= stanC) 
                        {
                            ...
                            write(pipe5_desc[1], &do_zaplaty_K2, sizeof(int));
                            //printf("magazyn: do zaplaty: %d\n", do_zaplaty_K2);
                        ...
                        {
                            do_zaplaty_K2 = 0;
                            printf("---Magazyn1 do kuriera2: NIE mozna zrealizowac zamowienia\n");
                ...
                if(pracujacy_kurier3==1)
                {
                    ...
                    else 
                    {
                        ...
                        if(message2.data_a <= stanA && message2.data_b <= stanB && message2.data_c <= stanC) 
                        {
                            ...
                            write(pipe6_desc[1], &do_zaplaty_K3, sizeof(int));
                            //printf("magazyn: do zaplaty: %d\n", do_zaplaty_K3);
                        ...
                        {
                            do_zaplaty_K3 = 0;
                            printf("---Magazyn1 do kuriera3: NIE mozna zrealizowac zamowienia\n");
